...
\begin{enumerate}
  ...
  \item \textbf{Authenticated pre-key design:} A hybrid PQ-X3DH bundle format with signed
        ...
        identity-misbinding vectors highlighted in the literature \cite{blake1997unknown}.
...
\noindent This proposition is a direct restatement of the sender-receiver third-party
unlinkability result established in Theorem~2 (proved in Appendix~A.2) of the Loopix security
analysis \cite{loopix}; the specific formula above is derived from that theorem under the
Poisson-mix model with cover traffic at rate $\lambda_{\mathrm{cover}}$.  We make no new claims
about mixnet security.  Star-Mesh's contribution is the integration of this overlay with the
hybrid post-quantum ratchet layer.
